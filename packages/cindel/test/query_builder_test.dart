...
void main() {
  group('Cindel query builder', () {
    ...
    // Scenario: A collection is opened with generated schema metadata but
    // receives generic map documents through [CindelDatabase.put].
    // Covers:
    // - Typed getAll over generic MDBX rows.
    // - Typed where, count, projection, and delete fallbacks after generic
    //   writes.
    // - Reopening a database that already contains generic rows.
